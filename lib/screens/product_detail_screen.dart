              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Center(
                            child: Text("${allProducts.first.price} EGP",
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                        "NOTE :  Discount of ${allProducts.first.discountPrice} EGP will be applied when you order more then three items of this product"),
                  ),
                  Container(
                    child: Row(
                      children: [
